...
### Changed
- Основной pipeline телеметрии/команд не изменился — этот релиз добавляет только
  диагностику и опциональный keep-alive, оба выключены/пассивны по умолчанию для
